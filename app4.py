...
if page == 'Analysis':
    ...
    fig = px.line(df_total[df_total["Asset"] == assets], x="Date", y=values, title= "Evoluation of each value (USD)")
...
## streamlit run "C:\Users\simao\Desktop\NOVA IMS\2nd Semester\Business Cases\BC5_dashboarding\app4.py"